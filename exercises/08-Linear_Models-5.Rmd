...
> Take the penguins take, then select the variables species, sex, and body mass, then filter the males, then group by species, and then calculate the mean body mass for each species.
