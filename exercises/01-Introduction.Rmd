...
# Lab 01 - Introduction to R {.panelset .sideways}
...
1. making your first plot in R. 
2. learning the basics of R
   - doing math
   - creating objects
   - using functions
3. creating an R Project folder
4. putting together an Rmarkdown document
   - adding R code
