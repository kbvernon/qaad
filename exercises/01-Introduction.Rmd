...
__tl;dr__ An introduction to R and R Markdown. 

### Objectives

This lab will guide you through the process of  

1. making sense of RStudio
2. making your first plot in R
3. learning the basics of R
   - doing math
   - creating objects
   - using functions
4. working through a typical workflow
4. creating an R Project folder
5. putting together an Rmarkdown document
   - adding R code
...
But, R is more than just a calculator. With it, you can _make_ things and you can _do_ things. The things that you make are called __objects__ and the things that you do things with are called __functions__. Any complex statistical operation you want to conduct in R will almost certainly involve the use of one or more functions.  
...
image_link(
  ...
  width = paste0(120, "px"),
  height = paste0(139, "px"),
  style = "float: left; margin-left: 10px; margin-right: 40px;"
)

```

[![](https://github.com/allisonhorst/stats-illustrations/blob/master/rstats-artwork/rmarkdown_wizards.png?raw=true)](https://github.com/allisonhorst/stats-illustrations)
...
- `message = FALSE` prevents R messages from appearing in the knitted document. 
- `warning = FALSE` prevents R warnings from appearing in the knitted document.
...
3. Notice that this template has two level two headers, "Lab Exercises" and "Homework Exercises." These are the two major assignments you will have to complete each week. You will enter all your answers in an rmd document with this format, then you will _knit_ that document to html, and submit it via Canvas. To keep these things organized, each exercise section in the lab should have its own level three header, like `### Plot` for this week. Since there is no R related homework assignment for this week, you can just delete that section from this rmd document. Before continuing, save your rmd document to the R folder in your course project directory.
4. Now, go back through this lab and re-do the exercises by adding them to this rmd document. Make sure to save that again. Then _knit_ it to html and submit it on the Canvas course page. This is the process that you will go through each week! 
