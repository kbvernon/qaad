...
[The Treachery of Images](https://en.wikipedia.org/wiki/The_Treachery_of_Images) (1929) by Rene Magritte.
:::
...
penguins |> pull(bill_length_mm)
penguins |> pull(bill_depth_mm)
...
![](images/booleans_example.png){#fig-booleans fig-align="center" width="40%"}
...
tibble(Boolean, Filter, Result) %>% gt()
